...
| --------------------- | --------------------------------------------------------- |
| Mac                   | `./bin/server-darwin-amd64 ORIGIN_ALLOWED=http://localhost:3000`   |
| Windows               | `./bin/server-windows-amd64.exe ORIGIN_ALLOWED=http://localhost:3000`   |
| Linux (Ubuntu, etc..) | `./bin/server-linux-amd64 ORIGIN_ALLOWED=http://localhost:3000` |
